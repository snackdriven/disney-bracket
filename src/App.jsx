...
const STATIC_META = {
  1:  { runtime:"88 min",  rating:"8.5", plot:"A lion prince flees his kingdom after his father's murder, then must return as an adult to reclaim what's his.", poster:"https://image.tmdb.org/t/p/w185/sKCr78MXSLixwmZ8DyJLrpMsd15.jpg" },
  2:  { runtime:"81 min",  rating:"8.3", plot:"A cowboy toy faces an identity crisis when a shiny new spaceman threatens to replace him as a child's favorite.", poster:"https://image.tmdb.org/t/p/w185/uXDfjJbdP4ijW5hWSBrPrlKpxab.jpg" },
  3:  { runtime:"100 min", rating:"8.1", plot:"A clownfish crosses the ocean to rescue his son, who's been taken to a dentist's aquarium in Sydney.", poster:"https://image.tmdb.org/t/p/w185/eHuGQ10FUzK1mdOY69wF5pGgEf5.jpg" },
  4:  { runtime:"84 min",  rating:"8.0", plot:"A young woman imprisoned in an enchanted castle slowly falls for the cursed beast who lives there.", poster:"https://image.tmdb.org/t/p/w185/hUJ0UvQ5tgE2Z9WpfuduVSdiCiU.jpg" },
  5:  { runtime:"83 min",  rating:"7.6", plot:"A mermaid princess makes a dangerous deal with a sea witch to become human and pursue the prince she loves.", poster:"https://image.tmdb.org/t/p/w185/plcZXvI310FkbwIptvd6rqk63LP.jpg" },
  6:  { runtime:"96 min",  rating:"8.3", plot:"A 78-year-old widower ties thousands of balloons to his house and floats to South America, stowaway included.", poster:"https://image.tmdb.org/t/p/w185/mFvoEwSfLqbcWwFsDjQebn9bzFe.jpg" },
  7:  { runtime:"90 min",  rating:"8.0", plot:"A street thief discovers a magic lamp with a wisecracking genie who grants three wishes, then falls for the princess.", poster:"https://image.tmdb.org/t/p/w185/eLFfl7vS8dkeG1hKp5mwbm37V83.jpg" },
  8:  { runtime:"95 min",  rating:"8.1", plot:"Inside an 11-year-old's mind, her emotions fight to help her navigate a difficult move to a new city.", poster:"https://image.tmdb.org/t/p/w185/2H1TmgdfNtsKlU9jKdeNyYL5y8T.jpg" },
  9:  { runtime:"105 min", rating:"8.4", plot:"A Mexican boy sneaks into the Land of the Dead on Día de los Muertos to find his music-loving ancestor.", poster:"https://image.tmdb.org/t/p/w185/6Ryitt95xrO8KXuqRGm1fUuNwqF.jpg" },
  10: { runtime:"102 min", rating:"7.4", plot:"A princess sets off to find her sister, whose uncontrolled ice magic has trapped their kingdom in eternal winter.", poster:"https://image.tmdb.org/t/p/w185/kgwjIb2JDHRhNk13lmSxiClFjVk.jpg" },
  11: { runtime:"115 min", rating:"8.0", plot:"A superhero family forced to live in hiding gets pulled back into action when an obsessive villain targets them.", poster:"https://image.tmdb.org/t/p/w185/2LqaLgk4Z226KkgPJuiOQ58wvrm.jpg" },
  12: { runtime:"98 min",  rating:"8.4", plot:"A lonely trash-compacting robot on an abandoned Earth falls in love and inadvertently saves humanity.", poster:"https://image.tmdb.org/t/p/w185/hbhFnRzzg6ZDmm8YAmxBnQpQIPh.jpg" },
  13: { runtime:"88 min",  rating:"7.6", plot:"A young woman secretly takes her ailing father's place in the Imperial Army to fight an invading Hun force.", poster:"https://image.tmdb.org/t/p/w185/jAbexAtB0aSfP5Ay4TpWHARyVnG.jpg" },
  14: { runtime:"100 min", rating:"7.7", plot:"A girl with magical 70-foot hair escapes her tower with a charming thief who agrees to take her to see the floating lanterns.", poster:"https://image.tmdb.org/t/p/w185/ym7Kst6a4uodryxqbGOxmewF235.jpg" },
  15: { runtime:"92 min",  rating:"8.1", plot:"Two monster employees discover that children's laughter generates more power than screams, upending their whole society.", poster:"https://image.tmdb.org/t/p/w185/wFSpyMsp7H0ttERbxY7Trlv8xry.jpg" },
  16: { runtime:"107 min", rating:"7.6", plot:"A Polynesian chief's daughter defies her island's rules to sail across the ocean and restore a stolen demigod's hook.", poster:"https://image.tmdb.org/t/p/w185/9tzN8sPbyod2dsa0lwuvrwBDWra.jpg" },
  17: { runtime:"111 min", rating:"8.1", plot:"A rat with extraordinary culinary talent secretly puppeteers a clumsy kitchen worker in a famous Parisian restaurant.", poster:"https://image.tmdb.org/t/p/w185/t3vaWRPSf6WjDSamIkKDs1iQWna.jpg" },
  18: { runtime:"103 min", rating:"8.3", plot:"Woody, Buzz, and the gang navigate a daycare run by a sinister plush bear when Andy heads to college.", poster:"https://image.tmdb.org/t/p/w185/AbbXspMOwdvwWZgVN0nabZq03Ec.jpg" },
  19: { runtime:"85 min",  rating:"7.3", plot:"A lonely Hawaiian girl adopts a strange alien creature being hunted by two incompetent intergalactic bounty hunters.", poster:"https://image.tmdb.org/t/p/w185/d73UqZWyw3MUMpeaFcENgLZ2kWS.jpg" },
  20: { runtime:"78 min",  rating:"7.3", plot:"An arrogant emperor turned into a llama by his scheming advisor must team up with a peasant to reclaim his throne.", poster:"https://image.tmdb.org/t/p/w185/isA0acj3ONKBLp1pKadUNzxEPFv.jpg" },
  21: { runtime:"74 min",  rating:"7.4", plot:"A kind young woman tormented by her stepfamily gets a magical chance at the royal ball and the prince who falls for her.", poster:"https://image.tmdb.org/t/p/w185/4nssBcQUBadCTBjrAkX46mVEKts.jpg" },
  22: { runtime:"93 min",  rating:"7.3", plot:"The son of Zeus, stripped of his immortality as an infant, trains to become a hero and earn his way back to Olympus.", poster:"https://image.tmdb.org/t/p/w185/dK9rNoC97tgX3xXg5zdxFisdfcp.jpg" },
  23: { runtime:"75 min",  rating:"7.2", plot:"A princess cursed to sleep forever by a vengeful fairy waits in an enchanted forest until a prince can break the spell.", poster:"https://image.tmdb.org/t/p/w185/n3pxoMDDxp10c1smgbDzW4bwlzq.jpg" },
  24: { runtime:"99 min",  rating:"7.2", plot:"The only member of a magical Colombian family without a gift sets out to save everyone's powers before they disappear.", poster:"https://image.tmdb.org/t/p/w185/4j0PNHkMr5ax3IA8tjtxcmPU3QT.jpg" },
  25: { runtime:"100 min", rating:"8.0", plot:"A jazz musician who dies on the best day of his life teams up with a prickly soul to find his way back to the living.", poster:"https://image.tmdb.org/t/p/w185/6jmppcaubzLF8wkXM36ganVISCo.jpg" },
  26: { runtime:"108 min", rating:"8.0", plot:"A rabbit cop and a con-artist fox investigate a conspiracy involving missing predators in a city of anthropomorphic animals.", poster:"https://image.tmdb.org/t/p/w185/hlK0e0wAQ3VLuJcsfIYPvb4JVud.jpg" },
  27: { runtime:"70 min",  rating:"7.3", plot:"A young deer grows up in a forest, confronting changing seasons and the ever-present danger of humans.", poster:"https://image.tmdb.org/t/p/w185/wV9e2y4myJ4KMFsyFfWYcUOawyK.jpg" },
  28: { runtime:"101 min", rating:"7.7", plot:"An arcade game villain tired of being the bad guy goes game-jumping to find a medal and earn some respect.", poster:"https://image.tmdb.org/t/p/w185/zWoIgZ7mgmPkaZjG0102BSKFIqQ.jpg" },
  29: { runtime:"88 min",  rating:"7.2", plot:"A man raised by gorillas in the African jungle encounters humans for the first time and is torn between two worlds.", poster:"https://image.tmdb.org/t/p/w185/bTvHlcqiOjGa3lFtbrTLTM3zasY.jpg" },
  30: { runtime:"78 min",  rating:"7.6", plot:"A human boy raised by wolves must leave his jungle home when a tiger threatens his life.", poster:"https://image.tmdb.org/t/p/w185/yN1kuupnPTLUprgfvC5WapgrxG4.jpg" },
  31: { runtime:"93 min",  rating:"7.1", plot:"A Scottish princess defies her fate and accidentally turns her mother into a bear, then scrambles to reverse the spell.", poster:"https://image.tmdb.org/t/p/w185/1XAuDtMWpL0sYSFK0R6EZate2Ux.jpg" },
  32: { runtime:"92 min",  rating:"7.9", plot:"Woody is stolen by a toy collector and must decide between a comfortable museum life or returning home to Andy.", poster:"https://image.tmdb.org/t/p/w185/yFWQkz2ynjwsazT6xQiIXEUsyuh.jpg" },
  33: { runtime:"100 min", rating:"7.7", plot:"Woody's sense of purpose unravels when he meets Forky — a spork who doesn't want to be a toy — and discovers an old friend.", poster:"https://image.tmdb.org/t/p/w185/w9kR8qbmQ01HwnvK4alvnQ2ca0L.jpg" },
  34: { runtime:"76 min",  rating:"7.3", plot:"A pampered cocker spaniel falls for a streetwise stray after she's displaced by her owners' new baby.", poster:"https://image.tmdb.org/t/p/w185/340NcWz9SQXWQyf4oicMxjbrLOb.jpg" },
  35: { runtime:"79 min",  rating:"7.2", plot:"Two dalmatians rally the animal kingdom to rescue their 99 stolen puppies from a fur-obsessed villain.", poster:"https://image.tmdb.org/t/p/w185/kSlYq6FrBUviGSEh8v4L9nrSnBT.jpg" },
  36: { runtime:"77 min",  rating:"7.3", plot:"Three London children fly to Neverland and join the boy who never grows up in his battle against Captain Hook.", poster:"https://image.tmdb.org/t/p/w185/fJJOs1iyrhKfZceANxoPxPwNGF1.jpg" },
  37: { runtime:"91 min",  rating:"6.9", plot:"A deformed bellringer at Notre Dame falls for a gypsy dancer while fighting the corrupt minister who wants her destroyed.", poster:"https://image.tmdb.org/t/p/w185/hImMgT9B27evYSRmfztqdDtX6qi.jpg" },
  38: { runtime:"83 min",  rating:"7.6", plot:"The first Disney feature: a princess flees her jealous stepmother and hides with seven dwarfs in an enchanted forest.", poster:"https://image.tmdb.org/t/p/w185/3VAHfuNb6Z7UiW12iYKANSPBl8m.jpg" },
  39: { runtime:"102 min", rating:"7.8", plot:"A young robotics prodigy and his late brother's inflatable healthcare robot form a superhero team to fight a masked villain.", poster:"https://image.tmdb.org/t/p/w185/2mxS4wUimwlLmI1xp6QW6NSU361.jpg" },
  40: { runtime:"107 min", rating:"7.3", plot:"A warrior princess journeys across a fractured land to reassemble a magical gem and revive the last dragon.", poster:"https://image.tmdb.org/t/p/w185/5nVhgCzxKbK47OLIKxCR1syulOn.jpg" },
  41: { runtime:"117 min", rating:"7.1", plot:"A hotshot race car crashes in a forgotten small town and slowly learns what matters more than winning.", poster:"https://image.tmdb.org/t/p/w185/2Touk3m5gzsqr1VsvxypdyHY5ci.jpg" },
  42: { runtime:"88 min",  rating:"7.4", plot:"Gepetto's wooden puppet is brought to life by a fairy and must prove himself brave, truthful, and unselfish to become real.", poster:"https://image.tmdb.org/t/p/w185/bnZJrLRnoQHpzEJdka1KYfsAF3N.jpg" },
  43: { runtime:"125 min", rating:"7.7", plot:"Animated segments set to classical music — Mickey Mouse as the Sorcerer's Apprentice, dinosaurs marching to Stravinsky, and more.", poster:"https://image.tmdb.org/t/p/w185/5m9njnidjR0syG2gpVPVgcEMB2X.jpg" },
  44: { runtime:"95 min",  rating:"7.4", plot:"Two sea monster boys disguised as humans spend a summer on the Italian Riviera chasing dreams of Vespa ownership.", poster:"https://image.tmdb.org/t/p/w185/9x4i9uKGXt8IiiIF5Ey0DIoY738.jpg" },
  45: { runtime:"81 min",  rating:"6.6", plot:"A Native American woman forms a forbidden bond with an English soldier as colonizers arrive to mine her land for gold.", poster:"https://image.tmdb.org/t/p/w185/kZ1ft0QZ4e3zDUPMBftEkwI9ftd.jpg" },
  46: { runtime:"75 min",  rating:"7.4", plot:"A curious girl falls down a rabbit hole into a nonsensical world populated by mad creatures and a tyrannical queen.", poster:"https://image.tmdb.org/t/p/w185/20cvfwfaFqNbe9Fc3VEHJuPRxmn.jpg" },
  47: { runtime:"100 min", rating:"7.5", plot:"Riley turns 13, and a new emotion — Anxiety — arrives and takes over her mind before a make-or-break hockey tryout.", poster:"https://image.tmdb.org/t/p/w185/vpnVM9B6NMmQpWeZvzLvDESb2QY.jpg" },
  48: { runtime:"97 min",  rating:"7.1", plot:"A New Orleans waitress gets turned into a frog after kissing the wrong prince and must find a way to break the curse.", poster:"https://image.tmdb.org/t/p/w185/v6nAUs62OJ4DXmnnmPFeVmMz8H9.jpg" },
  49: { runtime:"95 min",  rating:"7.2", plot:"A misfit ant destroys his colony's food offering and must recruit a circus troupe to defend them from grasshopper extortion.", poster:"https://image.tmdb.org/t/p/w185/Ah3J9OJVc2CNCuH2zMydXy9fmIC.jpg" },
  50: { runtime:"64 min",  rating:"7.2", plot:"A baby elephant mocked for his oversized ears discovers he can fly and becomes the star of a struggling circus.", poster:"https://image.tmdb.org/t/p/w185/4x9FmvdJ464Fg7A9XcbYSmxfVw3.jpg" },
  51: { runtime:"83 min",  rating:"7.5", plot:"The classic tale retold with foxes, bears, and a wolf sheriff in a medieval England populated entirely by animals.", poster:"https://image.tmdb.org/t/p/w185/x9AvkYek0bGdxQSZ8W3lAjGrREm.jpg" },
  52: { runtime:"104 min", rating:"7.3", plot:"A prequel following how Mike and Sulley met at college, both fighting to join the school's elite scare program.", poster:"https://image.tmdb.org/t/p/w185/y7thwJ7z5Bplv6vwl6RI0yteaDD.jpg" },
  53: { runtime:"95 min",  rating:"7.1", plot:"Stevenson's classic retold in space — a rebellious teen sets sail on a solar galleon to find legendary pirate treasure.", poster:"https://image.tmdb.org/t/p/w185/kNhZkR3UNbXfvESQo7mJpOi4tGd.jpg" },
  54: { runtime:"95 min",  rating:"6.9", plot:"A young linguist joins a secret expedition to find the sunken continent of Atlantis and unlock its ancient power source.", poster:"https://image.tmdb.org/t/p/w185/swYfLGplXAle5CenmWVYpRSomCp.jpg" },
  55: { runtime:"74 min",  rating:"7.2", plot:"Basil of Baker Street — the mouse version of Sherlock Holmes — races to stop a villain from seizing control of Mousedom.", poster:"https://image.tmdb.org/t/p/w185/9uDr7vfjCFr39KGCcqrk44Cg7fQ.jpg" },
  56: { runtime:"77 min",  rating:"7.3", plot:"Bernard and Bianca from the Rescue Aid Society travel to Australia to save a boy kidnapped by an eagle poacher.", poster:"https://image.tmdb.org/t/p/w185/5koTDBmMAkJOgAe4PL4163UKjvG.jpg" },
  57: { runtime:"79 min",  rating:"7.1", plot:"The wizard Merlin prepares a scrawny orphan named Wart for his destiny: to pull a magic sword from a stone.", poster:"https://image.tmdb.org/t/p/w185/7lyeeuhGAJSNXYEW34S8mJ1bwI8.jpg" },
  58: { runtime:"78 min",  rating:"7.1", plot:"An heiress's butler tries to lose her pampered cats in the countryside — the cats get help from an alley cat to find home.", poster:"https://image.tmdb.org/t/p/w185/1BVOSmQUhphMgnTxnXyfQ9tL1Sc.jpg" },
  59: { runtime:"96 min",  rating:"6.8", plot:"A TV dog star who believes his superpowers are real is accidentally shipped cross-country and must find his way back.", poster:"https://image.tmdb.org/t/p/w185/v5aC4nrzXFGJDWY4JO1eengXzqk.jpg" },
  60: { runtime:"95 min",  rating:"6.9", plot:"A science-obsessed orphan travels to the future and meets an eccentric family who might hold the secret to his past.", poster:"https://image.tmdb.org/t/p/w185/naya0zF4kT401Sx15AtwB9vpcJr.jpg" },
  61: { runtime:"85 min",  rating:"6.9", plot:"A young hunter transformed into a bear must befriend the very bear he hunted in order to become human again.", poster:"https://image.tmdb.org/t/p/w185/otptPbEY0vBostmo95xwiiumMJm.jpg" },
  62: { runtime:"77 min",  rating:"7.1", plot:"Two mice from the Rescue Aid Society travel to a Louisiana swamp to save a kidnapped girl from a diamond thief.", poster:"https://image.tmdb.org/t/p/w185/9jpDjrRyvv9Nw0piXOpHHQTfxw9.jpg" },
  63: { runtime:"74 min",  rating:"6.7", plot:"A kitten joins a gang of New York City street dogs led by a smooth-talking human criminal, then gets adopted into luxury.", poster:"https://image.tmdb.org/t/p/w185/x8XqdiZ0Oxu5iXF9SiFub9Lae8J.jpg" },
  64: { runtime:"101 min", rating:"6.8", plot:"In a city where fire, water, land, and air elements coexist uneasily, a fiery woman and a water guy break their world's rules.", poster:"https://image.tmdb.org/t/p/w185/4Y1WNkd88JXmGfhtWR7dmDAo1T2.jpg" },
  65: { runtime:"100 min", rating:"7.0", plot:"A 13-year-old Toronto girl discovers she turns into a giant red panda whenever she gets too excited or emotional.", poster:"https://image.tmdb.org/t/p/w185/qsdjk9oAKSQMWs0Vt5Pyfh6O4GZ.jpg" },
  66: { runtime:"102 min", rating:"7.3", plot:"Two elf brothers set out on a quest to use a magic staff to bring their late father back for just one day.", poster:"https://image.tmdb.org/t/p/w185/f4aul3FyD3jv3v4bul1IrkWZvzq.jpg" },
  67: { runtime:"81 min",  rating:"5.8", plot:"A young chicken who once caused town-wide panic over nothing must convince everyone that the sky really is falling this time.", poster:"https://image.tmdb.org/t/p/w185/87FpA4b90eTaw3U6zmCNikoPLir.jpg" },
  68: { runtime:"118 min", rating:"7.6", plot:"Elastigirl goes on a mission to legalize superheroes while Mr. Incredible stays home and struggles with the kids.", poster:"https://image.tmdb.org/t/p/w185/9lFKBtaVIhP7E2Pk0IY1CwTKTMZ.jpg" },
  69: { runtime:"112 min", rating:"7.0", plot:"Wreck-It Ralph and Vanellope venture into the internet to find a replacement part for her game before it's shut down.", poster:"https://image.tmdb.org/t/p/w185/iVCrhBcpDaHGvv7CLYbK6PuXZo1.jpg" },
  70: { runtime:"93 min",  rating:"6.7", plot:"In a world where dinosaurs survived the asteroid, a timid young dinosaur befriends a feral human boy after getting lost.", poster:"https://image.tmdb.org/t/p/w185/8RSkxOO80btfKjyiC5ZiTaCHIT8.jpg" },
};
